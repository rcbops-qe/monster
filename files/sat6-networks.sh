...
destroy() {
    for i in `neutron floatingip-list | awk '{print $2}'`; do neutron floatingip-delete $i; done
    for i in `neutron port-list | awk '{print $2}'`; do neutron port-delete $i; done
    for i in `neutron router-list | awk '{print $2}'`; do neutron router-delete $i; done
    for i in `nova list | awk '{print $2}'`; do nova delete $i; done
    for i in `neutron net-list | awk '{print $2}'`; do neutron net-delete $i; done
}
