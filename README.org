...
** Installation
   ...
   - Clone the repo and install
     #+BEGIN_SRC sh
       git clone https://github.com/rcbops-qa/monster.git /opt/monster
       virtualenv -p `which python2` /opt/monster/.venv
       source /opt/monster/.venv/bin/activate
       pip install -r /opt/monster/requirements.txt
     #+END_SRC
